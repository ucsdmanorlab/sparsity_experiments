...
skels = glob.glob(f"../{ds}/data/*.db")

f = zarr.open(f,"r")
raw = f["raw"]
labels = f["labels_filtered_relabeled"]
...
#        )
        ...
        print(skel_file, len(self.skeletons.nodes()), len(self.skeletons.edges()))
        print("")
...
with viewer.txn() as s: 
    ...
    for skel in skels:
        ...
        s.layers[name].skeleton_rendering.line_width3d = 1
